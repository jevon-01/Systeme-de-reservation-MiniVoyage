...
public:
	Hebergement(const string& categorie, const vector<string>& details, const string& nom, const double p, const string& v, const string& s, const double cote, const Devise& d = Devise()) : Offre(categorie, details, nom, p, d), ville(v), secteur(s), cote(cote){};
	~Hebergement() = default;
